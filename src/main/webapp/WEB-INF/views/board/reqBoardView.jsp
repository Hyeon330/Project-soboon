	...
	<div class="row">
		...
		<div class="col-6 rqb">
			...
			<div class="ProductBtns">
				...
				<c:if test="${logId==viewVo.userid}">
					<div class="col-12 text-center pb">
						<a href="/board/reqBoardEdit?no=${viewVo.no}" class="btn" id="reqBoardEdit">수정</a>
						<span id="btnSpace"></span><input type="button" class="btn" id="reqBoardDel" value="삭제"/>
					</div>
				</c:if>
			</div>
		</div>
		...
		<div class="col-12 rp">
			...
			<div><i class="fa fa-comment fa-lg"></i><span class="iconValue">댓글</span></div>
				<form method="post" id="replyForm">
					...
					<div id="commentLine">
						<textarea name="coment" id="coment" class="reqBoardComent" rows="4" cols="80" placeholder="내용을 입력하세요"></textarea>
