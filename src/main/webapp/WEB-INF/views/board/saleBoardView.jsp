...
<link rel="stylesheet" href="/css/saleBoardView.css" type="text/css"/>
<script src="/js/boardViewReply.js"></script>
<script src="/js/saleBoardView.js"></script>
<script>
	let nickname = "${nickName}";

	$(function(){
		$("#saleBoardDel").click(function(){
			if(confirm("삭제하시겠어요?")){
				location.href="/board/saleBoardDel?no=${viewVo.no}";
			}	
		});
	...
	<div class="row">
		...
		<div class="col-6 sab">
			...
			<div class="ProductBtns">
				...
				<c:if test="${logId==viewVo.userid}">
					<div class="col-12 text-center pb">
						<a href="/board/saleBoardEdit?no=${viewVo.no}" class="btn" id="saleBoardEdit">수정</a>
						<span id="btnSpace"></span><input type="button" class="btn" id="saleBoardDel" value="삭제"/>
					</div>
				</c:if>
			</div>
			<!-- 글내용 -->
		...
		<div class="col-12 rp">
			...
			<div><i class="fa fa-comment fa-lg"></i><span class="iconValue">댓글</span></div>
				<form method="post" id="replyForm">
					...
					<div id="commentLine">
						<textarea name="coment" id="coment" class="saleBoardComent" rows="4" cols="80" placeholder="내용을 입력하세요"></textarea>
