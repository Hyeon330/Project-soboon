...
<div class="container">
	<div class="row">
		<div class="col-6 sbi">
			<div id="demo" class="carousel carouselslide" data-ride="carousel">
				<c:choose>
		...
		<div class="col-6 sb">
			<div id="productTitle">
				...
				<h2>
					<span id="titleInner">${viewVo.title}</span>
				</h2>
			</div>
			<hr />
			<div id="productIcon">
				...
				<c:if test="${logId==viewVo.userid}">
					<div class="proIcon">
						<i class="fa fa-heart fa-lg"></i><span class="iconValue">${viewVo.pick}</span>
					</div>
				</c:if>
				<div class="proIcon">
					<i class="fa fa-eye fa-lg"></i><span class="iconValue">${viewVo.views}</span>
				</div>
				<div class="proIcon">
					<i class="fa fa-clock fa-lg"></i><span class="iconValue">${viewVo.createdate}</span>
				</div>
				<c:if test="${logId!=viewVo.userid}">
					<div class="btn" id="proWarn">
						<i class="fa fa-bell"></i><span class="iconValue">신고하기</span>
					</div>
				</c:if>
			...
			<div class="ProductBtns">
				...
				<c:if test="${logId==viewVo.userid}">
					<div class="col-12 text-center pb">
						...
						<input type="button" class="btn" id="shareBoardDel" value="삭제" />
					</div>
				</c:if>
			</div>
			<!-- 글내용 -->
