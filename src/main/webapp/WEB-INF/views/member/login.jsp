	...
	<div id="login">
		...
		<form method="post" action="/member/loginOk" id="loginFrm" onsubmit="return loginFrmCheck()">
			<ul>
				...
				<br/>
				<li><a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=4f0872694d90dd12a1b5d2f2045a544b&redirect_uri=http://3.35.208.207:8080/member/kakao"><img src="/img/kakao_login_button.png" class="kakaoBtn"/></a></li>
